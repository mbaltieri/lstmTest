...
Simple LSTM, inpired by http://www.jessicayung.com/lstms-for-time-series-in-pytorch/. Code at https://github.com/jessicayung/blog-code-snippets/blob/master/lstm-pytorch/lstm-baseline.py.
